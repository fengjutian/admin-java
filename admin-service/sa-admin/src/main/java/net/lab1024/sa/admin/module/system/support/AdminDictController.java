...
public class AdminDictController extends SupportBaseController {
    ...
    @Operation(summary = "分页查询  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "添加  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "更新  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "启用/禁用  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "批量删除  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "单个删除  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "字典数据 分页查询  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "字典数据 启用/禁用  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "字典数据 添加  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "字典数据 更新  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "字典数据 批量删除  1024创新实验室-主任-卓大")
    ...
    @Operation(summary = "字典数据 单个删除  1024创新实验室-主任-卓大")

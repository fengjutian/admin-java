...
public class AdminDictController extends SupportBaseController {
    ...
    @Operation(summary = "字典数据 分页查询  -主任-")
    ...
    @Operation(summary = "字典数据 启用/禁用  -主任-")
    ...
    @Operation(summary = "字典数据 批量删除  -主任-")
    ...
    @Operation(summary = "字典数据 单个删除  -主任-")
